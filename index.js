...
app.post("/", (request, response) => {
    ...
    if(location == "Y Diner"){
        ...
        if(dietaryRestrictions != "None"){
            ...
            holder1 = Yahentamitsi.breakfast.slice();
            holder2 = Yahentamitsi.lunch.slice();
            holder3 = Yahentamitsi.dinner.slice();
        }
        ...
        if(dietaryRestrictions != "None"){
            ...
            holder1 = South_Diner.breakfast.slice();
            holder2 = South_Diner.lunch.slice();
            holder3 = South_Diner.dinner.slice();
        }
        ...
        if(dietaryRestrictions != "None"){
            ...
            holder1 = North_Diner.breakfast.slice();
            holder2 = North_Diner.lunch.slice();
            holder3 = North_Diner.dinner.slice();
        }
